...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 1594376528645876078),
      name: 'Email',
      lastPropertyId: const IdUid(6, 7566055598549608001),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 2042961489621358740),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 3634620583075537431),
            name: 'from',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 4940561819756037757),
            name: 'to',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 2023405538144420758),
            name: 'subject',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 8807034618256471439),
            name: 'body',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(6, 7566055598549608001),
            name: 'receivedDate',
            type: 10,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 1594376528645876078),
